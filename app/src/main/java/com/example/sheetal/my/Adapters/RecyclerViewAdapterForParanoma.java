...
public class RecyclerViewAdapterForParanoma extends RecyclerView.Adapter<RecyclerViewAdapterForParanoma.ViewHolder> {
    ...
    public RecyclerViewAdapterForParanoma(Context context, ArrayList<Integer> imageUrls, ArrayList<String> names) {
        mNames = names;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.paranomalayout, parent, false);
